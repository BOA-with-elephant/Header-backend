...
public class TokenDTO {
    ...
    private Integer shopCode;       // 회원이 갖고 있는 샵의 샵 코드  #샵을 여러개 갖고있는 경우는 어떡하지?
    private String accessToken; 		// 액세스 토큰
    private Long accessTokenExpiresIn;	// Long 형의 만료 시간

    public TokenDTO(String grantType, String userId, Integer shopCode, String accessToken, Long accessTokenExpiresIn) {
